...
public class SnorView extends View{
    ...
    public SnorView(Context context) {
        this(context,null);
    }

    public SnorView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);

    }

    public SnorView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        */
        ...
        paint=new Paint();
        paint.setColor(getResources().getColor(R.color.sorning));
    ...
    public synchronized void setSnorData(final int data){
               ...
               public void run() {
                   ...
                   if(count==pointsOfEachPulse){
                       ...
                       for(int i=0; i<pointsOfEachPulse; i++){
                           if(i==1){
                               pointsHeight[points+i]=h/2;
                           }else if(i==2){
                               pointsHeight[points+i]=3*h/2;
                           }else if (i==3){
                               pointsHeight[points+i]=1*h/4;
                           }else if(i==4){
                               pointsHeight[points+i]=h+3*h/4;
                           }else{
                               pointsHeight[points+i]=h;
                           }
